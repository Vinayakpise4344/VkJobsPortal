        ...
        <div className="flex justify-between">
          ...
          <Button onClick={()=>setopen(true)}  className="text-right" variant="outline"><Pen/></Button>
                ...
                <div className='grid w-full max-w-sm items-center gap-1.5'>
                    <Label
                     className="text-md font-bold">Resume</Label>
                    {
                        isResume ? <a target='blank' href="https://github.com/Vinayakpise4344" className='text-blue-500 w-full hover:underline cursor-pointer'></a> : <span>NA</span>
                    }
                </div>
            </div>
